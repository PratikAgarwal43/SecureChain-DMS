...
def create_case(
    ...
    with db_cursor() as cur:
        cur.execute("""
            INSERT INTO cases (id, title, description, jurisdiction, case_type, created_by, status)
            VALUES (%s, %s, %s, %s, %s, %s, 'OPEN')
        """, (case_id, body.title, body.description, body.jurisdiction, body.case_type, current_user["sub"]))
    ...
    return {"case_id": case_id, "title": body.title, "status": "OPEN"}
